# -*- coding: utf-8 -*-
#
# napari-WEA documentation build configuration file, created by
...
project = u'napari-WEA'
copyright = u'2015, Daniel Elnatan'
author = u'Daniel Elnatan'
...
man_pages = [
    (main_doc, 'napari-cookiecutterplugin_name', u'napari-WEA Documentation',
     [author], 1)
]
